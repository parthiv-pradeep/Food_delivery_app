...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 overflow-hidden min-h-screen sm:min-h-[80vh] animate-gradient">
      ...
      {/* Mobile-specific floating food animations with enhanced aesthetics */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center min-h-[calc(100vh-140px)] sm:min-h-auto">
          ...
          <div className="text-white text-center lg:text-left order-2 lg:order-1">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 sm:mb-6 mobile-hero-text">
              ...
              <span className="block text-yellow-300 animate-pulse">Delivered Fast</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 px-2 sm:px-0">
              <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-2 lg:p-0 lg:bg-transparent mobile-glass mobile-card-hover">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-200">30 mins or less</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-2 lg:p-0 lg:bg-transparent mobile-glass mobile-card-hover">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-200">4.8+ ratings</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-2 lg:p-0 lg:bg-transparent mobile-glass mobile-card-hover">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-200">Orders over $30</p>
                </div>
              </div>
            </div>
          </div>

          {/* Mobile-Optimized Hero Image with enhanced aesthetics */}
          <div className="relative order-1 lg:order-2 mb-4 lg:mb-0">
            ...
            <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-8 overflow-hidden mx-4 sm:mx-0 mobile-glass mobile-card-hover">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-200/20 to-red-200/20 rounded-2xl sm:rounded-3xl animate-pulse-slow"></div>
              
              {/* Main Food Image - Mobile Optimized with enhanced animations */}
              <div className="relative aspect-square bg-gradient-to-br from-yellow-100 to-orange-200 rounded-xl sm:rounded-2xl flex items-center justify-center overflow-hidden animate-gradient">
                <div className="text-center transform hover:scale-105 transition-transform duration-300">
                  {/* Large Attractive Food Image - Responsive with enhanced animations */}
                  <div className="text-6xl sm:text-8xl md:text-9xl mb-2 sm:mb-4 animate-pulse-slow">🍕</div>
                  <div className="absolute top-2 sm:top-4 left-2 sm:left-4 text-2xl sm:text-4xl animate-bounce food-bounce-1">🍔</div>
                  <div className="absolute top-2 sm:top-4 right-2 sm:right-4 text-2xl sm:text-4xl animate-bounce food-bounce-2">🍜</div>
                  <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 text-2xl sm:text-4xl animate-bounce food-bounce-3">🌮</div>
                  <div className="absolute bottom-2 sm:bottom-4 right-2 sm:right-4 text-2xl sm:text-4xl animate-bounce food-bounce-4">🍣</div>
                  
                  <div className="bg-white/90 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-4 mx-2 sm:mx-4 mobile-glass">
                    <p className="text-sm sm:text-lg font-bold text-gray-800 mb-1">Fresh & Delicious</p>
                    <p className="text-xs sm:text-sm text-gray-600">Food delivered hot</p>
                    <div className="flex items-center justify-center mt-1 sm:mt-2">
                      <div className="flex text-yellow-400 text-sm sm:text-base">
                        ⭐⭐⭐⭐⭐
                      </div>
                      <span className="ml-2 text-xs sm:text-sm font-semibold text-gray-700">4.9/5</span>
                    </div>
                  </div>
                </div>
              </div>
